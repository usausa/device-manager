...
using DeviceMonitor.Server.Services;
using DeviceMonitor.Server.Web.Components;
...
builder.Services
    ...
    .AddJsonOptions(options =>
    {
        ...
        options.JsonSerializerOptions.Converters.Add(new DeviceMonitor.Server.Components.Json.DateTimeConverter());
    });
