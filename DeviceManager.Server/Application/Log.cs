...
internal static partial class Log
{
    ...
    [LoggerMessage(Level = LogLevel.Information, Message = "Device connected. deviceId=[{deviceId}]")]
    public static partial void InfoDeviceConnected(this ILogger logger, string deviceId);

    [LoggerMessage(Level = LogLevel.Information, Message = "Device disconnected. deviceId=[{deviceId}]")]
    public static partial void InfoDeviceDisconnected(this ILogger logger, string deviceId);
