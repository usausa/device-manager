...
public sealed class DeviceManagerClient : IAsyncDisposable
{
        ...
        IDeviceCommandHandler? commandHandler = null)
    {
        ...
        _configManager = new ConfigManager(
            ...
            _signalRConnectionManager, _grpcConnectionManager,
    ...
    public Task ConnectAsync(CancellationToken cancellationToken = default)
    {
        ...
        return _useGrpc
            ? _grpcConnectionManager!.ConnectAsync(cancellationToken)
            : _signalRConnectionManager!.ConnectAsync(cancellationToken);
    }
